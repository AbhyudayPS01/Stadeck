...
| Module | Challenge clause | What it does |
| --- | --- | --- |
| Navigation | improve navigation | Gate + section route planner: AI turn-by-turn directions, highlighted route overlay on the schematic map, closest restroom/food/exit callouts. |
